                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-lg-inline-flex"><?php echo $_SESSION['Usuarios_Nombres'];   ?></span>
                            <small class="text-muted"><?php echo $_SESSION['Rol'];?></small>
                            <input type="hidden" id="Usuario_IdRoles" name="Usuario_IdRoles" value="<?php  echo $_SESSION["Usuario_IdRoles"] ?>">
